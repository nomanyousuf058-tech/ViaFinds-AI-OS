...
- Name: tests\e2e\manual-publishing.spec.ts >> Manual Publishing Dashboard Workflow >> should show empty queue message after all packages are removed
- Location: tests\e2e\manual-publishing.spec.ts:102:7
...
```ts
  ...
  6   |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
  ...
  28  |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
  ...
  42  |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
  ...
  50  |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
  ...
  59  |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
  ...
  77  |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
  ...
  90  |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
...
> 103 |     await page.goto('http://127.0.0.1:3000/dashboard/publish-queue');
      |                ^ Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/dashboard/publish-queue
